    ...
    while itera:
        ...
        if menu == 1:
           if num_user_in == 0 and num_user_out == 0: #Se le tabelle user_in e user_out sono vuote, allora
             ...
             if near_aoi_is_null != 0: # Se esistono righe con aoi nulla allora bisogna calcolare le aoi più vicine (opzione 4)
                ...
                while iter: # Per iterare il sottomenu
                    ...
                    if id_selector < num_id_distinct + 1 and id_selector != 0: # Se il numero immesso e' inferiore al numero massimo di utenti e diverso da 0, allora
                       ...
                       dot_id = cursor.fetchall() # Visualizza le righe dalla tabella \'db\' dove id_user e' uguale a quello selezionato dall\'utente. In ordine di tempo, dal più vecchio al più nuovo
                       ...
                       for dot in dot_id:
                           ...
                           if num_aoi_user_in != 0:
                              print "in...ATTENDERE... Righe da processare: ", num_dot
                              for aoi in aoi_user_in:
                              ...
                              print "out...ATTENDERE... Righe da processare: ", num_dot
                              for near_aoi in aoi_user_out:
                                  aoi_list.append(near_aoi[0])
                           num_dot = num_dot - 1
                       print aoi_list
                       iter = False
                    elif id_selector == 0:
